...
export default function MeasurementsScreen({ navigation }: any) {
  ...
  const measurementList = [
    ...
    { label: 'Chest / Bust', value: measurementData.chest, icon: '👔' },
    { label: 'Under Bust', value: measurementData.underbust ?? 0, icon: '👙' },
    ...
    { label: 'Half Length', value: measurementData.halfLength ?? 0, icon: '📐' },
    { label: 'Top Length', value: measurementData.topLength ?? 0, icon: '📏' },
    { label: 'Bicep', value: measurementData.roundSleeveBicep ?? 0, icon: '💪' },
    { label: 'Elbow', value: measurementData.roundSleeveElbow ?? 0, icon: '🦾' },
