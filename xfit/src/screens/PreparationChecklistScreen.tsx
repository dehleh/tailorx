...
const initialItems: CheckItem[] = [
  ...
  },
  {
    ...
    description: 'All three angles are required for a standard fitting scan',
    hint: 'Back view improves shoulder balance, back width, posture, and garment fit checks',
    hintColor: Colors.primary,
    checked: false,
  },
  {
